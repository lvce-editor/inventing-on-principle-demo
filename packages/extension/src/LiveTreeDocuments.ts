export const liveTreeHtml = `<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Inventing on Principle · Live Tree</title>
    <link rel="stylesheet" href="./inventing-on-principle.css">
  </head>
  <body>
    <main>
    ...
    <script src="./inventing-on-principle.js"></script>
  </body>
</html>
`

export const liveTreeCss = `* {
...
export const liveTreeJavaScript = `// Try depth: 7 → 10, spread: 0.42 → 0.7, or wind: 0 → 0.12.
const depth = 8
const spread = 0.48
